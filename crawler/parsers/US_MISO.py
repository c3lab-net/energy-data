...
# Source: https://github.com/electricitymap/electricitymap-contrib/blob/master/parsers/US_MISO.py
...
def fetch_production(zone_key='US-MISO', session=None, target_datetime=None, logger=logging.getLogger(__name__)) -> dict:
...
def fetch_wind_forecast(zone_key='US-MISO', session=None, target_datetime=None, logger=None) -> list:
